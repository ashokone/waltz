...
public class LogicalFlowDecorationLoader implements SampleDataGenerator {

    @Override
    public Map<String, Integer> create(ApplicationContext ctx) {

        DataTypeService dataTypeService = ctx.getBean(DataTypeService.class);
        ...
        DataType dataType = dataTypeService.getDataTypeByCode("UNKNOWN");
        ...
        List<LogicalFlowDecoratorRecord> records = map(
                ...
                id -> {
                    ...
                    record.setDecoratorEntityId(dataType.id().get());
